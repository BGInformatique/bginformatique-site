...
# à jour ? »
#
# Usage :  ./outils/cr-8h4m2v/verifier-deploiement.sh
#
...
BASE="https://bginformatique.ca/outils/cr-8h4m2v"
DOSSIER="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
FICHIERS=("index.html" "css/style.css" "js/app.js" "js/firebase-config.js")
